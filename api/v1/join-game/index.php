...
$status = file_get_contents("http://roblox.robloxlabs.com/game/placelauncherstatus.ashx"); 
$url = "http://roblox.robloxlabs.com/scripts/joinscripts/$clientyear?&id=$id&port=$port&year=$clientyear&username=$username&membership=$membership&ip=$ip&port=$port";
?>
{
  "jobId": "Test",
  "status": 2,
  ...
  "joinScript": {
    ...
    "GameId": "string",
    "PlaceId": 0,
    "BaseUrl": "http://roblox.robloxlabs.com/",
