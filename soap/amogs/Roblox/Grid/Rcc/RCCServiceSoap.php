...
class RCCServiceSoap {
  ...
  function __construct($url = "37.143.61.72", $port = 48434) {
    $this->ip = $url;
    $this->port = $port;
    $this->url = $url.$port;
    $this->SoapClient = new SoapClient(__DIR__."/RCCService.wsdl", ["location" => "http://".$url.":".$port, "uri" => "http://mulrbx.com/", "classmap" => $this->classmap, "exceptions" => false]);
  }
