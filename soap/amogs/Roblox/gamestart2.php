...
$porty = file_get_contents("http://mulrbx.com/portdetect.php?id=" . $GameId);
 ...
 $RCCServiceSoap = new Roblox\Grid\Rcc\RCCServiceSoap("37.143.61.72", 56217);
...
$job = new Roblox\Grid\Rcc\Job($id,700000);
        ...
        $scriptText = file_get_contents('gameserver2.lua') . " start(\"".$_GET['id']."\",\"". $porty ."\",\"http://".$_SERVER['SERVER_NAME']."\");";
