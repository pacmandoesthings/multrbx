...
local ICON_HEIGHT = LayoutInfo.IndicatorHeight
local BOTTOM_DISTANCE = LayoutInfo.IndicatorBottomDistance
local BUTTON_DISTANCE = LayoutInfo.IndicatorButtonsDistance
local ICON_TEXT_DISTANCE = LayoutInfo.IndicatorIconTextDistance
...
local fullViewContainerPosition = UDim2.new(0.5, -totalContainerSizeX/2 + switchTypeContainerSizeX + BUTTON_DISTANCE, 1, -BOTTOM_DISTANCE)
