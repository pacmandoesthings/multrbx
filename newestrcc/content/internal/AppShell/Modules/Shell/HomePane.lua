...
local IsCrossplayEnabled = Utility.IsFastFlagEnabled("XboxUseCrossPlatformPlay5")
...
local function CreateHomePane(parent)
	...
	local friendsScroller = ScrollingGridModule({Dynamic = EnableXboxFriendsEvents})
