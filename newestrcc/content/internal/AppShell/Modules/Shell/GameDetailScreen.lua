...
local ShowExperimentalTag = Utility.IsFastFlagEnabled('XboxShowExperimentalTag5')
...
--[[ Badges ]]--
	...
	do
		...
		local function loadDescriptionDataAsync()
			...
			local isExperimental = ShowExperimentalTag and data.IsExperimental
			setNoteDisplay(overridesDefaultAvatar, isExperimental)
