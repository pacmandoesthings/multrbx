...
if url~=nil then
	pcall(function() game:GetService("Players"):SetAbuseReportUrl("http://www.roblox.com/AbuseReport/InGameChatHandler.ashx") end)
	...
	pcall(function() game:GetService("Players"):SetChatFilterUrl("http://www.roblox.com/Game/ChatFilter.ashx") end)
