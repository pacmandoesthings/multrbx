								 ...
								 <div id="PersonalBlurbSetting" class="SettingSubTitle">
									...
									<div id="BlurbDesc">
									   ...
									   <div id="blurbSubtext" class="footnote">
										  Do not provide any details that can be used to identify you outside of ROBLOX.
					 ...
					 <div id="AccountPageRight">
						<div id="UpgradeAccount" style="margin-left: 10px">
						   ...
						   <div id="buyRobux" class="upgrade-account-button">
							  <a href="/Upgrades/Robux.ashx" class="btn-medium btn-primary">Buy Robux
							  <span class="btn-text">Buy Robux</span></a>
						   </div>
						   <div id="JoinBuildersClub" class="upgrade-account-button">
							  <a href="/Upgrades/" class="btn-medium btn-primary">
							  Join Builders Club
							  <span class="btn-text">Join Builders Club</span></a>
						   </div>
                                                    <div id="JoinBuildersClub" class="upgrade-account-button">
							  <a href="/Upgrades/RedeemGameCard.aspx" class="btn-medium btn-primary">
							  Redeem Game Card
							  <span class="btn-text">Redeem Game Card</span></a>
						   </div>
