...
local assetId = 2 -- might be able to remove this now
...
game:SetPlaceID(2, false)
game:GetService("ChangeHistoryService"):SetEnabled(false)

-- establish this peer as the Server
local ns = game:GetService("NetworkServer")

local url = "http://www.mulrbx.com/"
...
if url~=nil then
	...
	game:GetService("BadgeService"):SetPlaceId(2)
	...
	game:GetService("InsertService"):SetAssetVersionUrl(url .. "/asset/?assetversionid=%d")
        game:GetService("SocialService"):SetGroupUrl("http://mulrbx.com/Game/LuaWebService/HandleSocialRequest.ashx?method=IsInGroup&playerid=%d&groupid=%d")
        game:GetService("SocialService"):SetGroupRankUrl("http://mulrbx.com/Game/LuaWebService/HandleSocialRequest.ashx?method=GetGroupRank&playerid=%d&groupid=%d")
        game:GetService("SocialService"):SetGroupRoleUrl("http://mulrbx.com/Game/LuaWebService/HandleSocialRequest.ashx?method=GetGroupRole&playerid=%d&groupid=%d")
 game:GetService("SocialService"):SetFriendUrl("http://mulrbx.com/Game/LuaWebService/HandleSocialRequest.ashx?method=IsFriendsWith&playerid=%d&userid=%d")
 game:GetService("SocialService"):SetBestFriendUrl("http://mulrbx.com/Game/LuaWebService/HandleSocialRequest.ashx?method=IsBestFriendsWith&playerid=%d&userid=%d")
	pcall(function() loadfile(url .. "/Game/LoadPlaceInfo.ashx?PlaceId=" .. 2)() end)
	
	-- pcall(function() 
	--			if access then
	--				loadfile(url .. "/Game/PlaceSpecificScript.ashx?PlaceId=" .. 2 .. "&" .. access)()
	--			end
	--		end)
end
